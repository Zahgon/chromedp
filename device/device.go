...
func (i Info) Device() Info { _ = "STUB: not implemented"; return *new(Info) }

type infoType int

func (i infoType) String() string { _ = "STUB: not implemented"; return "" }

func (i infoType) Device() Info { _ = "STUB: not implemented"; return *new(Info) }
